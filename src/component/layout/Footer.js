    ...
    <footer className="footer-wrapper">
      <div className="footer-container container">
        <div className="footer-column three columns" id="footer-widget-1">
          <div id="text-5" className="widget widget_text gdlr-item gdlr-widget">
            ...
            <div className="textwidget">
              <p><i className="gdlr-icon fa fa-phone" style={{color: '#fff', fontSize: '16px'}} /> +84-123-456-0000</p>
              <div className="clear" />
              <div className="gdlr-space" style={{marginTop: '-15px'}} />
              <p><i className="gdlr-icon fa fa-envelope-o" style={{color: '#fff', fontSize: '16px'}} /> Shilla@MonoGram.com</p>
              <div className="clear" />
              <div className="gdlr-space" style={{marginTop: '25px'}} />
              <p>
              <Link to="http://themeforest.net/user/goodlayers/" target="_blank">
              <i className="gdlr-icon fa fa-facebook-square" style={{color: '#fff', fontSize: '24px'}} /></Link> 
              <Link to="http://themeforest.net/user/goodlayers/" target="_blank">
              <i className="gdlr-icon fa fa-twitter-square" style={{color: '#fff', fontSize: '24px'}} /></Link> 
              <Link to="http://themeforest.net/user/goodlayers/" target="_blank">
              <i className="gdlr-icon fa fa-linkedin-square" style={{color: '#fff', fontSize: '24px'}} /></Link> 
              <Link to="http://themeforest.net/user/goodlayers/" target="_blank">
              <i className="gdlr-icon fa fa-google-plus-square" style={{color: '#fff', fontSize: '24px'}} /></Link> 
              <Link to="http://themeforest.net/user/goodlayers/" target="_blank">
              <i className="gdlr-icon fa fa-pinterest-square" style={{color: '#fff', fontSize: '24px'}} /></Link> 
              <Link to="http://themeforest.net/user/goodlayers/" target="_blank">
              <i className="gdlr-icon fa fa-flickr" style={{color: '#fff', fontSize: '24px'}} /></Link></p>
            </div>
          </div>
        </div>
        ...
        <div className="footer-column six columns" id="footer-widget-3">
          <div id="text-10" className="widget widget_text gdlr-item gdlr-widget">
            <h3 className="gdlr-widget-title">Ngoài ra</h3>
            <div className="clear" />
            <div className="textwidget"><img src="frontend\anh\logo.png" alt="" />
              <div className="clear" />
      ...
      <div className="copyright-wrapper">
        <div className="copyright-container container">
          <div className="copyright-left">
            <Link to="/" style={{marginRight: '10px'}}>Trang chủ</Link>|<Link to="/booking" style={{marginRight: '10px', marginLeft: '10px'}}>Đặt phòng</Link> </div>
